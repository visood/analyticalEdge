...
compareIndpInter <- function(vs){
  X12.train.indp <- compTrain[, vs]
  X12.train.indp$Happy <- compTrain$Happy
  X12.test.indp <- compTest[, vs]
  X12.test.indp$Happy <- compTest$Happy
  ...
  X12.train.int <- makeInteraction(compTrain[, vs])
  X12.train.int$Happy <- compTrain$Happy
  X12.test.int <- makeInteraction(compTest[, vs])
  X12.test.int$Happy <- compTest$Happy
